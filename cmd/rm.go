...
var rmCmd = &cobra.Command{
	...
	Long:  `Remove a sandbox container. The credentials volume is preserved so you don't need to re-authenticate. Use -all to also remove the credentials volume.`,
